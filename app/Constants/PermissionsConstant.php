...
class PermissionsConstant
{
    ...
    public static function groupedTranslations(): array
    {
        return [
            ...
            self::SCIENTIFIC_ARTICLE_CITATION_CONFIRM_PAGE => __('Илмий мақолаларга иқтибосларни тасдиқлаш саҳифаси (1.5-жадвал)'),
            ...
            self::SCIENTIFIC_ARTICLE_CONFIRM_PAGE => __('Илмий мақолаларни тасдиқлаш саҳифаси (1.6.1-жадвал)'),
            ...
            self::OAK_SCIENTIFIC_ARTICLE_CONFIRM_PAGE => __('Илмий мақолалар (ОАК рўйхатидаги)ни тасдиқлаш саҳифаси (1.6.2-жадвал)'),
            ...
            self::SCIENTIFIC_RESEARCH_EFFECTIVENESS_CONFIRM_PAGE => __('Илмий-тадқиқот ишларининг самарадорлигини тасдиқлаш саҳифаси (1.9.1-жадвал)'),
            ...
            self::OBTAINED_INDUSTRIAL_SAMPLE_PATENT_CONFIRM_PAGE => __('Профессор-ўқитувчилар томонидан ихтиролари учун олинган патентларни тасдиқлаш саҳифаси (1.9.2-жадвал)'),
            ...
            self::COPYRIGHT_PROTECTED_VARIOUS_MATERIAL_INFORMATION_CONFIRM_PAGE => __('Гувоҳномалар, муаллифлик ҳуқуқи билан ҳимоя қилинадиган турли материалларни тасдиқлаш саҳифаси (1.9.3-жадвал)'),
