@extends('layout')
@section('meta')
    <meta name="sort" content="{{route('phd_doctors.index')}}">
    <meta name="filter" content="{{route('phd_doctors.index')}}">
@endsection
...
@section('content')
            ...
            <table class="table table-striped text-center table-bordered" id="users-list">
                ...
                @foreach($doctors as $doctor)
                    <tr>
                        ...
                        <td>
                            <a href="{{route('phd_doctors.edit', $doctor->id)}}" class="btn btn-warning btn-flat btn-sm">
    ...
    <x-delete :url="route('phd_doctors.delete', 'ID')"/>
@endsection
