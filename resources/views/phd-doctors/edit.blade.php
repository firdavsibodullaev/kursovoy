@extends('layout')
@section('title', $phd->user_full_name)
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">{{$phd->user_full_name}}</li>
@endsection
@section('content')
    <div class="card">
        <div class="card-body">
            @include('partials.messages')
            <form action="{{route('phd_doctors.update', $phd->id)}}" method="post" autocomplete="off">
                @csrf
                @method('put')
                <div class="row">
                    <div class="col-4">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="text"
                                   ...
                                   value="{{$phd->professor_without_science_degree['series'] ?? null}}"
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <input type="number"
                                   ...
                                   value="{{$phd->professor_without_science_degree['number'] ?? null}}"
