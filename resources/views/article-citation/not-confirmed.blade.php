...
@section('content')
    <div class="card">
        <div class="card-body">
            <h3 class="text-center">
                Навоий давлат кончилик институтида ҳалқаро кўрсаткичларга кўра профессор-ўқитувчиларнинг илмий
    ...
    <x-delete :url="route('article_citation.delete', ['ID', 'status' => 'not-confirmed'])"/>
@endsection
